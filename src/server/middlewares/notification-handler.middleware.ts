...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'payment_received.create': { roles: ['owner', 'administrator'], key: 'payment', tenantPath: [], userPath: [] },
  'support_ticket_opened.create': { roles: ['owner', 'administrator'], key: 'support', tenantPath: [], userPath: [] },
};
